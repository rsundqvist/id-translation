...
Mapping of the current `value` is aborted if an empty set is returned. Functions such as
:func:`~id_translation.mapping.filter_functions.filter_names` and
:func:`~id_translation.mapping.filter_functions.filter_sources` use this to allow (or disallow) names and sources that
