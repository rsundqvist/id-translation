...
class NounTransformer:
    """Utility class for transforming nouns to singular form.
    ...
    Examples:
        ...
        See :attr:`PLURAL_TO_SINGULAR_SUFFIXES` for affectd suffixes.
    ...
    PLURAL_TO_SINGULAR_SUFFIXES = [
        ("ies", "y"),  # cities -> city
        ("ves", "f"),  # wolves -> wolf
        ("es", ""),  # analyses -> analysis, and many others
        ("s", ""),  # catch-all
    ]
